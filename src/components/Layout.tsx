...
const Layout = ({ pageTitle, children }: { pageTitle: string, children: React.ReactNode }) => {
  ...
  return (
    <div className='relative'>
      {/* <div className='h-[70vh] absolute top-0 left-0 w-full -z-10 dark-gradient-bg'></div> */}
      ...
      <nav className='flex space-x-10 px-10 py-5  justify-end text-lg font-semibold'>
        <Link to="/">Home</Link>
...
function Footer() {
  // dark-gradient-bg
  return <footer className="relative pt-8 pb-6  text-black mt-20">
